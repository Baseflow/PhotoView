...
import com.github.chrisbanes.photoview.sample.fresco.PhotoDraweeView;
...
public class FrescoSampleActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fresco_simple_sample);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_scale_fit_center:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.FIT_CENTER);
                        return true;

                    case R.id.menu_scale_fit_start:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.FIT_START);
                        return true;

                    case R.id.menu_scale_fit_end:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.FIT_END);
                        return true;

                    case R.id.menu_scale_fit_xy:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.FIT_XY);
                        return true;

                    case R.id.menu_scale_scale_center:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.CENTER);
                        return true;

                    case R.id.menu_scale_scale_center_crop:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.CENTER_CROP);
                        return true;

                    case R.id.menu_scale_scale_center_inside:
                        mPhotoView.getHierarchy().setActualImageScaleType(ScalingUtils.ScaleType.CENTER_INSIDE);
                        return true;
...
//        mPhotoView.setImageDrawable(bitmap);
        mPhotoView.setImageURI(Uri.parse("http://imgsrc.baidu.com/imgad/pic/item/7dd98d1001e93901cf713c2d71ec54e736d196b6.jpg"));
    ...
    private void showToast(CharSequence text) {
        ...
        mCurrentToast = Toast.makeText(FrescoSampleActivity.this, text, Toast.LENGTH_SHORT);
        mCurrentToast.show();
    }
